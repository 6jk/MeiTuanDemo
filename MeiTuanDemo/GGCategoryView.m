...
- (void)setupUI {
    ...
    [categoryNameArr enumerateObjectsUsingBlock:^(NSString * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        UIButton *btn = [UIButton ggButtonWithText:obj fontSize:16 normalColor:kGrayColor selectedColor:kOrangeColor];
